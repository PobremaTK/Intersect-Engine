...
public partial class Controls
{
    ...
    public void ResetDefaults()
    {
        ...
        CreateControlMap(Control.Hotkey10, new ControlValue(Keys.None, Keys.F1), ControlValue.Default);
        CreateControlMap(Control.Hotkey11, new ControlValue(Keys.None, Keys.F2), ControlValue.Default);
        CreateControlMap(Control.Hotkey12, new ControlValue(Keys.None, Keys.F3), ControlValue.Default);
        CreateControlMap(Control.Hotkey13, new ControlValue(Keys.None, Keys.F4), ControlValue.Default);
        CreateControlMap(Control.Hotkey14, new ControlValue(Keys.None, Keys.F5), ControlValue.Default);
        CreateControlMap(Control.Hotkey15, new ControlValue(Keys.None, Keys.F6), ControlValue.Default);
        CreateControlMap(Control.Hotkey16, new ControlValue(Keys.None, Keys.F7), ControlValue.Default);
        CreateControlMap(Control.Hotkey17, new ControlValue(Keys.None, Keys.F8), ControlValue.Default);
        CreateControlMap(Control.Hotkey18, new ControlValue(Keys.None, Keys.F9), ControlValue.Default);
        CreateControlMap(Control.Hotkey19, new ControlValue(Keys.None, Keys.F10), ControlValue.Default);
